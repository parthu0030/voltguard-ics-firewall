...
class PhysicsConfig:
    ...
    # Rated operating speed used by the internal hydraulic-demand controller.
    # It is not exposed as a manual operator setpoint.
    ...
    def _validate(self) -> None:
        ...
        if not (0 < self.pump_rpm_nominal <= self.pump_rpm_max):
            errors.append("pump nominal RPM must satisfy 0 < nominal <= max")
